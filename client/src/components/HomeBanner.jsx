...
export default function HomeBanner() {
  ...
  return (
    <>
      <section className='border-transparent mt-[70px] h-[60vh] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-between px-10'>
